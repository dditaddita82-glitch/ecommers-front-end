...
"[project]/src/app/(main)/customer/orders/[id]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OrderDetailPage({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(`/orders/${unwrappedParams.id}`).then((res)=>{
            if (res.data.success) {
                setOrder(res.data.data);
            }
        }).catch((err)=>console.error("Gagal load detail order:", err)).finally(()=>setLoading(false));
    }, [
        unwrappedParams.id
    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e19abd53._.js.map