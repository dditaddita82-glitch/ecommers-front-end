...
"[project]/src/app/(main)/customer/dashboard/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UserDashboard() {
        ...
        const fetchData = async ()=>{
            try {
                const [ordersRes, productsRes] = await Promise.all([
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("/products?limit=3")
                ]);
    ...
    const metrics = [
        ...
        {
            label: "Total Belanja",
            value: `Rp ${totalSpending.toLocaleString("id-ID")}`
        }
    ];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c88e0192._.js.map