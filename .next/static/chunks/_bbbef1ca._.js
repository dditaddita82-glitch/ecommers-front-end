...
"[project]/src/components/product/product-gallery.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                    ...
                    fileName: "[project]/src/components/product/product-gallery.tsx",
                    lineNumber: 15,
                    columnNumber: 9
                }, this)
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: images.map((img, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: "overflow-hidden rounded-md border ".concat(idx === active ? "border-primary" : "border-muted"),
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                            src: img,
...
_s(ProductGallery, "LYMHw6xE17pbh6ai9qaw76OM0Ms=");
_c = ProductGallery;
var _c;
...
function useCart() {
    ...
    const fetchCart = async ()=>{
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/cart");
            if (res.data.success) {
    ...
    const addToCart = async function(productId) {
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/cart/items", {
                productId,
                quantity
            });
            if (res.data.success) {
                setCart(res.data.data);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Produk ditambahkan ke keranjang");
                return true;
            }
        } catch (err) {
            var _err_response;
            const errorData = (_err_response = err.response) === null || _err_response === void 0 ? void 0 : _err_response.data;
            let errorMessage = (errorData === null || errorData === void 0 ? void 0 : errorData.message) || "Gagal menambahkan produk";
            // Jika error validasi Zod (array of errors)
            if ((errorData === null || errorData === void 0 ? void 0 : errorData.errors) && Array.isArray(errorData.errors)) {
                errorMessage = errorData.errors.map((e)=>"".concat(e.field, ": ").concat(e.message)).join(", ");
            }
    ...
    const updateQuantity = async (productId, quantity)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].patch("/cart/items/".concat(productId), {
                quantity
            });
            if (res.data.success) {
                setCart(res.data.data);
    ...
    const removeFromCart = async (productId)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].delete("/cart/items/".concat(productId));
            if (res.data.success) {
                setCart(res.data.data);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Produk dihapus dari keranjang");
                return true;
            }
        } catch (err) {
    ...
    const clearCart = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].delete("/cart");
            if (res.data.success) {
                setCart(res.data.data);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Keranjang berhasil dikosongkan");
                return true;
            }
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Gagal mengosongkan keranjang");
            console.error(err);
            return false;
        }
    };
    ...
    const subtotal = (cart === null || cart === void 0 ? void 0 : cart.items.reduce((sum, item)=>sum + Number(item.product.price) * item.quantity, 0)) || 0;
    const totalItems = (cart === null || cart === void 0 ? void 0 : cart.items.reduce((sum, item)=>sum + item.quantity, 0)) || 0;
    return {
        cart,
        loading,
        error,
...
_s(useCart, "LKsTsXpw9o5BBZnUleWNYa1X5Ow=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function useWishlist() {
    ...
    const addToWishlist = (product)=>{
        ...
        if (existing) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("Produk sudah ada di wishlist");
            return;
        }
        const newWishlist = [
            ...wishlist,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Ditambahkan ke wishlist");
    };
    const removeFromWishlist = (productId)=>{
        const newWishlist = wishlist.filter((item)=>item.id !== productId);
        setWishlist(newWishlist);
        localStorage.setItem("wishlist", JSON.stringify(newWishlist));
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Dihapus dari wishlist");
    };
...
_s(useWishlist, "gAEaL3jXJCWhBzbNqcuCWyZw68k=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/(main)/customer/products/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$product$2f$product$2d$gallery$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/product/product-gallery.tsx [app-client] (ecmascript)");
...
function ProductDetailPage(param) {
    let { params } = param;
    var _product_images, _product_category;
    _s();
    ...
    const { addToWishlist, removeFromWishlist, isInWishlist } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useWishlist$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWishlist"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailPage.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/products/".concat(unwrappedParams.id)).then({
                ...
                "ProductDetailPage.useEffect": (err)=>console.error("Gagal mengambil data produk:", err)
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: "Memuat detail produk..."
        }, void 0, false, {
            fileName: "[project]/src/app/(main)/customer/products/[id]/page.tsx",
            lineNumber: 34,
            columnNumber: 12
        }, this);
    }
    ...
    const handleWishlistToggle = ()=>{
        if (isWished) {
            ...
            addToWishlist({
                ...
                image: ((_product_images = product.images) === null || _product_images === void 0 ? void 0 : _product_images[0]) || "/placeholder.jpg"
            });
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "grid grid-cols-1 gap-10 p-6 lg:grid-cols-2",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$product$2f$product$2d$gallery$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProductGallery"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            "Kategori: ",
                            ((_product_category = product.category) === null || _product_category === void 0 ? void 0 : _product_category.name) || "Umum"
                        ]
                    }, void 0, true, {
                        fileName: "[project]/src/app/(main)/customer/products/[id]/page.tsx",
                        lineNumber: 64,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        children: product.stock > 0 ? "Add to Cart" : "Stok Habis"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(main)/customer/products/[id]/page.tsx",
                        lineNumber: 74,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        children: isWished ? "Hapus dari Wishlist" : "Add to Wishlist"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(main)/customer/products/[id]/page.tsx",
                        lineNumber: 83,
                        columnNumber: 9
...
_s(ProductDetailPage, "QU2VsxU7SaUWDTt8gdUuI8SoS/M=", false, function() {
    return [
...
//# sourceMappingURL=_bbbef1ca._.js.map