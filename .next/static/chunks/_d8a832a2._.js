...
"[project]/src/app/(main)/admin/categories/add/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AddCategoryPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/categories", {
                name,
                slug
            });
            if (res.data.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res.data.message || "Gagal menambahkan kategori");
            }
        } catch (error) {
...
_s(AddCategoryPage, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
...
//# sourceMappingURL=_d8a832a2._.js.map